...
namespace MyVaccine.WebApi.Migrations
{
    ...
    [Migration("20250523040148_AddingAuditFields")]
            ...
            modelBuilder.Entity("MyVaccine.WebApi.Models.VaccineRecord", b =>
                {
                    ...
                    b.ToTable("VaccinesRecord");
                });

            modelBuilder.Entity("VaccineCategoryVaccines", b =>
                {
                    ...
                    b.HasKey("CategoryId", "VaccineId");

                    b.HasIndex("VaccineId");

                    b.ToTable("VaccineCategoryVaccines");
                });
