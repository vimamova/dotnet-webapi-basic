        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FamilyGroups_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VaccineCategoryVaccines", x => new { x.CategoryId, x.VaccineId });
                    table.ForeignKey(
                        name: "FK_VaccineCategoryVaccines_VaccineCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "VaccineCategories",
                        principalColumn: "VaccineCategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VaccineCategoryVaccines_Vaccines_VaccineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VaccinesRecord", x => x.VaccineRecordId);
                    table.ForeignKey(
                        name: "FK_VaccinesRecord_Dependents_DependentId",
                        column: x => x.DependentId,
                        principalTable: "Dependents",
                        principalColumn: "DependentId");
                    table.ForeignKey(
                        name: "FK_VaccinesRecord_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VaccinesRecord_Vaccines_VaccineId",
                        column: x => x.VaccineId,
                        principalTable: "Vaccines",
                        principalColumn: "VaccineId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VaccineCategoryVaccines_VaccineId",
                table: "VaccineCategoryVaccines",
                column: "VaccineId");

            migrationBuilder.CreateIndex(
                name: "IX_VaccinesRecord_DependentId",
                table: "VaccinesRecord",
                column: "DependentId");

            migrationBuilder.CreateIndex(
                name: "IX_VaccinesRecord_UserId",
                table: "VaccinesRecord",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_VaccinesRecord_VaccineId",
                table: "VaccinesRecord",
                column: "VaccineId");
        }
